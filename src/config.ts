...
export const config: SiteConfig = {
  title: "John Engates",
  description: "Artificial Intelligence and cybersecurity researcher exploring agentic AI, multi-agent systems, and their applications in cybersecurity and quantum-ready computing. Former CTO at Rackspace. Former Field CTO at Cloudflare. Investor, advisor, board member.",
  author: {
    name: "John Engates",
